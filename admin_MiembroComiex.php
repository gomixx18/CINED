                            ...
                            <div class=""><h3 class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Modificar Miembro</h3>
                                ...
                                <form role="form" id="frm_agregar_estudiante" method="POST" action="funcionalidad/INVModificar.php">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-danger pull-left m-t-n-xs" type="submit" name="desactivarMiembroComiex" id="desactivar" ><i class="fa fa-warning"></i><strong> Desactivar</strong></button>
                                        <button class="btn btn-sm btn-info pull-left m-t-n-xs" type="submit" name="activarMiembroComiex" id="activar" ><i class="fa fa-check-circle"></i><strong> Activar</strong></button>
                                        
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="INVModificarMiembro"><strong>Modificar</strong></button>
                                        <button type="button" data-dismiss="modal" class="btn btn-sm btn-secundary pull-right m-t-n-xs" style="margin-right: 20px;" ><strong>Cancelar</strong></button>
