                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                            ...
                                            <tbody>
                                                ...
                                                $query = mysqli_query($connection, "SELECT * FROM miembroscomisiontfg");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=""><h3 class="m-t-none m-b"> <i class="fa fa-plus-square-o"></i> Agregar Miembro a la Comision</h3>
                                <form role="form" id="frm_agregar_estudiante" method="POST" action="funcionalidad/TFGagregar.php">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit" name="TFGagregarMiembroComision"><strong>Registar</strong></button>
